...
export default function WritingProfileWizard({ onClose, onSuccess, editMode = false, existingProfile = null }) {
  ...
  const renderStep1 = () => (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">Give your writing profile a name and optional description.</p>
      </div>
  ...
  const renderStep2 = () => {
    ...
    return (
      <div className="space-y-6">
        <div>
          <h3 className="text-xl font-bold text-gray-900 mb-2">Issues You Care About</h3>
          <p className="text-gray-600">Select issues and specify your position, priority, and why you care.</p>
        </div>
              ...
              >
                <label className="flex items-start cursor-pointer">
                  ...
                  <div className="flex-1">
                    ...
                    {isSelected && (
                      <div className="mt-3 space-y-3 pl-6 border-l-2 border-blue-300">
                        <div>
  ...
  const renderStep3 = () => (
    <div className="space-y-6">
      <div>
        <h3 className="text-xl font-bold text-gray-900 mb-2">Abortion Position</h3>
        <p className="text-gray-600">This issue often requires more nuanced positioning. Select your stance (optional).</p>
      </div>
  ...
  const renderStep4 = () => (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">Select 3-5 core values that guide your political decisions.</p>
      </div>
  ...
  const renderStep5 = () => (
    <div className="space-y-6">
      <div>
        <h3 className="text-xl font-bold text-gray-900 mb-2">Writing Tone</h3>
  ...
  const renderStep6 = () => {
    ...
    return (
      <div className="space-y-6">
        <div>
          <h3 className="text-xl font-bold text-gray-900 mb-2">Argumentative Frameworks</h3>
          <p className="text-gray-600">Select the types of arguments you want to emphasize in your letters.</p>
        </div>
        ...
        <div className="space-y-2">
          {politicalData?.engagement_approaches?.aligned?.map((approach) => (
            ...
            >
              ...
              />
              <div>
                <div className="font-medium text-gray-900">{approach.label}</div>
                <div className="text-xs text-gray-600">{approach.description}</div>
              </div>
            </label>
          ))}
        </div>
    ...
    return (
      <div className="space-y-6 max-h-[300px] sm:max-h-[500px] overflow-y-auto">
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 space-y-4">
          ...
          <div>
            <h4 className="font-semibold text-gray-900">Key Issues ({selectedIssues.length})</h4>
              ...
              {selectedIssues.map((issueValue) => {
                ...
                return (
                  <div key={issueValue} className="border-l-4 border-blue-400 pl-3 py-1">
                    <div className="font-medium text-gray-900">{issue?.label || issueValue}</div>
          ...
          {formData.abortion_position && (
            <div>
              <h4 className="font-semibold text-gray-900">Abortion Position</h4>
          ...
          <div>
            <h4 className="font-semibold text-gray-900">Core Values ({formData.core_values.length})</h4>
          ...
          <div>
            <h4 className="font-semibold text-gray-900">Argumentative Frameworks</h4>
            <div className="flex flex-wrap gap-2 mt-2">
          ...
          <div>
            <h4 className="font-semibold text-gray-900">Representative Engagement</h4>
