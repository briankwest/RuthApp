...
function RepresentativeCard({ rep, onSave }) {
  ...
  const PlaceholderAvatar = () => (
    <div className="w-24 h-24 rounded-lg bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center flex-shrink-0">
          ...
          <div className="mt-4 space-y-2">
            ...
            {rep.contact?.email && (
              <div className="flex items-center gap-2 text-sm">
                ...
                <a href={`mailto:${rep.contact.email}`} className="text-blue-600 hover:underline">
                  {rep.contact.email}
                </a>
              </div>
            )}
            ...
            {rep.contact?.website && (
              <div className="flex items-center gap-2 text-sm">
                ...
                <a href={rep.contact.website} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline truncate">
                  {rep.contact.website}
                </a>
              </div>
            )}
...
export default function RepresentativesPage() {
  ...
  const usePrimaryAddress = () => {
    const primaryAddress = userAddresses.find(addr => addr.is_primary);
    if (primaryAddress) {
      setAddress({
        street: primaryAddress.street_1,
        city: primaryAddress.city,
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6 p-6">
      ...
      <div>
        <h1 className="text-3xl font-bold text-gray-900">Find Your Representatives</h1>
