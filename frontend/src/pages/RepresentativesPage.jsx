          ...
          <div className="mt-4 space-y-2">
            ...
            {rep.contact?.email && (
              <div className="flex items-center gap-2 text-sm min-w-0">
                ...
                <a href={`mailto:${rep.contact.email}`} className="text-blue-600 hover:underline truncate break-all">
                  {rep.contact.email}
                </a>
              </div>
            )}
            ...
            {rep.contact?.website && (
              <div className="flex items-center gap-2 text-sm min-w-0">
                ...
                <a href={rep.contact.website} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline truncate break-all">
                  {rep.contact.website}
                </a>
              </div>
            )}
